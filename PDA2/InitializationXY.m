function [P,x0,measurement,trackState,qualityOfTrack,numberOfTrack] = InitializationXY( pointsToBeInitialized,numberOfmea)
...
for i = 1:numberOfTrack
    ...
    x0(1,1,i) = pointsToBeInitialized(1,i);
    x0(2,1,i) = 0;
    x0(3,1,i) = pointsToBeInitialized(2,i);
    x0(4,1,i) = 0;
